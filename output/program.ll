...
; Class Nil
%Nil = type {%NilVTable*}
%NilVTable = type {%Object* (%Object*, i8*)*, %Object* (%Object*, i32)*, i1 (%Object*)*, i8* (%Object*)*, i32 (%Object*)*, %Object* (%Object*, i1)*, i32 (%List*)*, i1 (%List*)*}

; Class Cons
%Cons = type {%ConsVTable*, i32, %List*}
%ConsVTable = type {%Object* (%Object*, i8*)*, %Object* (%Object*, i32)*, i1 (%Object*)*, i8* (%Object*)*, i32 (%Object*)*, %Object* (%Object*, i1)*, i32 (%Cons*)*, i1 (%Cons*)*, i32 (%Cons*)*, %Cons* (%Cons*, i32, %List*)*}

; Class Object
%Object = type {%ObjectVTable*}
%ObjectVTable = type {%Object* (%Object*, i8*)*, %Object* (%Object*, i32)*, i1 (%Object*)*, i8* (%Object*)*, i32 (%Object*)*, %Object* (%Object*, i1)*}

; Class List
%List = type {%ListVTable*}
%ListVTable = type {%Object* (%Object*, i8*)*, %Object* (%Object*, i32)*, i1 (%Object*)*, i8* (%Object*)*, i32 (%Object*)*, %Object* (%Object*, i1)*, i32 (%List*)*, i1 (%List*)*}

; Class Main
%Main = type {%MainVTable*}
%MainVTable = type {%Object* (%Object*, i8*)*, %Object* (%Object*, i32)*, i1 (%Object*)*, i8* (%Object*)*, i32 (%Object*)*, %Object* (%Object*, i1)*, i32 (%Main*)*}

; 
; VTables
; 
@Nil___vtable = constant %NilVTable {%Object* (%Object*, i8*)* @Object__print, %Object* (%Object*, i32)* @Object__printInt32, i1 (%Object*)* @Object__inputBool, i8* (%Object*)* @Object__inputLine, i32 (%Object*)* @Object__inputInt32, %Object* (%Object*, i1)* @Object__printBool, i32 (%List*)* @List__length, i1 (%List*)* @List__isNil}
@Cons___vtable = constant %ConsVTable {%Object* (%Object*, i8*)* @Object__print, %Object* (%Object*, i32)* @Object__printInt32, i1 (%Object*)* @Object__inputBool, i8* (%Object*)* @Object__inputLine, i32 (%Object*)* @Object__inputInt32, %Object* (%Object*, i1)* @Object__printBool, i32 (%Cons*)* @Cons__length, i1 (%Cons*)* @Cons__isNil, i32 (%Cons*)* @Cons__head, %Cons* (%Cons*, i32, %List*)* @Cons__init}
@Object___vtable = constant %ObjectVTable {%Object* (%Object*, i8*)* @Object__print, %Object* (%Object*, i32)* @Object__printInt32, i1 (%Object*)* @Object__inputBool, i8* (%Object*)* @Object__inputLine, i32 (%Object*)* @Object__inputInt32, %Object* (%Object*, i1)* @Object__printBool}
@List___vtable = constant %ListVTable {%Object* (%Object*, i8*)* @Object__print, %Object* (%Object*, i32)* @Object__printInt32, i1 (%Object*)* @Object__inputBool, i8* (%Object*)* @Object__inputLine, i32 (%Object*)* @Object__inputInt32, %Object* (%Object*, i1)* @Object__printBool, i32 (%List*)* @List__length, i1 (%List*)* @List__isNil}
@Main___vtable = constant %MainVTable {%Object* (%Object*, i8*)* @Object__print, %Object* (%Object*, i32)* @Object__printInt32, i1 (%Object*)* @Object__inputBool, i8* (%Object*)* @Object__inputLine, i32 (%Object*)* @Object__inputInt32, %Object* (%Object*, i1)* @Object__printBool, i32 (%Main*)* @Main__main}
; 
; Functions
; 
...
define i32 @Main__main (%Main*) {
	...
	%6 = bitcast %Cons* %5 to %Cons*
	%7 = getelementptr %Cons, %Cons* %6, i32 0,i32 0
	%8 = load %ConsVTable*, %ConsVTable** %7
	%9 = getelementptr %ConsVTable, %ConsVTable* %8, i32 0,i32 9
	%10 = load %Cons* (%Cons*, i32, %List*)*, %Cons* (%Cons*, i32, %List*)** %9
	%11 = bitcast i32 0 to i32
	%12 = getelementptr %Cons, %Cons* null, i32 1
	%13 = ptrtoint %Cons* %12 to i64
	%14 = call i8* @malloc(i64 %13)
	%15 = bitcast i8* %14 to %Cons*
	%16 = bitcast %Cons* %15 to %Cons*
	%17 = getelementptr %Cons, %Cons* %16, i32 0,i32 0
	%18 = load %ConsVTable*, %ConsVTable** %17
	%19 = getelementptr %ConsVTable, %ConsVTable* %18, i32 0,i32 9
	%20 = load %Cons* (%Cons*, i32, %List*)*, %Cons* (%Cons*, i32, %List*)** %19
	%21 = bitcast i32 1 to i32
	%22 = getelementptr %Cons, %Cons* null, i32 1
	%23 = ptrtoint %Cons* %22 to i64
	%24 = call i8* @malloc(i64 %23)
	%25 = bitcast i8* %24 to %Cons*
	%26 = bitcast %Cons* %25 to %Cons*
	%27 = getelementptr %Cons, %Cons* %26, i32 0,i32 0
	%28 = load %ConsVTable*, %ConsVTable** %27
	%29 = getelementptr %ConsVTable, %ConsVTable* %28, i32 0,i32 9
	%30 = load %Cons* (%Cons*, i32, %List*)*, %Cons* (%Cons*, i32, %List*)** %29
	%31 = bitcast i32 2 to i32
	%32 = getelementptr %Nil, %Nil* null, i32 1
	%33 = ptrtoint %Nil* %32 to i64
	%34 = call i8* @malloc(i64 %33)
	%35 = bitcast i8* %34 to %Nil*
	%36 = bitcast %Nil* %35 to %List*
	%37 = call %Cons* %30(%Cons* %26, i32 %31, %List* %36)
	%38 = bitcast %Cons* %37 to %List*
	%39 = call %Cons* %20(%Cons* %16, i32 %21, %List* %38)
	%40 = bitcast %Cons* %39 to %List*
	%41 = call %Cons* %10(%Cons* %6, i32 %11, %List* %40)
	%42 = bitcast %Cons* %41 to %List*
	%43 = bitcast %Main* %0 to %Object*
	%44 = getelementptr %Object, %Object* %43, i32 0,i32 0
	%45 = load %ObjectVTable*, %ObjectVTable** %44
	%46 = getelementptr %ObjectVTable, %ObjectVTable* %45, i32 0,i32 0
	%47 = load %Object* (%Object*, i8*)*, %Object* (%Object*, i8*)** %46
	%48 = bitcast i8* getelementptr inbounds ([17 x i8], [17 x i8]* @Main__main.str.0, i64 0, i64 0) to i8*
	%49 = call %Object* %47(%Object* %43, i8* %48)
	%50 = bitcast %Main* %0 to %Object*
	%51 = getelementptr %Object, %Object* %50, i32 0,i32 0
	%52 = load %ObjectVTable*, %ObjectVTable** %51
	%53 = getelementptr %ObjectVTable, %ObjectVTable* %52, i32 0,i32 1
	%54 = load %Object* (%Object*, i32)*, %Object* (%Object*, i32)** %53
	%55 = bitcast %List* %42 to %List*
	%56 = getelementptr %List, %List* %55, i32 0,i32 0
	%57 = load %ListVTable*, %ListVTable** %56
	%58 = getelementptr %ListVTable, %ListVTable* %57, i32 0,i32 6
	%59 = load i32 (%List*)*, i32 (%List*)** %58
	%60 = call i32 %59(%List* %55)
	%61 = bitcast i32 %60 to i32
	%62 = call %Object* %54(%Object* %50, i32 %61)
	%63 = bitcast %Main* %0 to %Object*
	%64 = getelementptr %Object, %Object* %63, i32 0,i32 0
	%65 = load %ObjectVTable*, %ObjectVTable** %64
	%66 = getelementptr %ObjectVTable, %ObjectVTable* %65, i32 0,i32 0
	%67 = load %Object* (%Object*, i8*)*, %Object* (%Object*, i8*)** %66
	%68 = bitcast i8* getelementptr inbounds ([2 x i8], [2 x i8]* @Main__main.str.1, i64 0, i64 0) to i8*
	%69 = call %Object* %67(%Object* %63, i8* %68)
	ret i32 0
}
